...
corrected_samples_file = "Samples/corrected_samples_entropy.txt"
if os.path.exists(corrected_samples_file):
    ...
    corrected_texts, self_accuracies = pipe.self_correction(
        texts, num_inference_steps=128, early_stopping=True, temperature=0.1, tokens_per_step=10, selection_strategy="entropy", return_metrics=True
    )
...
comparison_file = "Samples/comparison_entropy.json"
...
gen_metrics_file = "Samples/generated_samples_entropy.json"
...
corr_metrics_file = "Samples/corrected_samples_metrics_entropy.json"
